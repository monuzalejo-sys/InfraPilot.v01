...
- **Hoy, 8 días después de marcarlo: sigue vivo.** `infrapilot/PEND-018` se abrió el
  ...
  lleva más de una semana y mientras tanto está publicado.
...
- `infrapilot/PEND-018` + `ORION/infrapilot-app/app/(auth)/login/page.tsx:14, 104-105` —
  el testimonio inventado, todavía en disco a 2026-08-24.
