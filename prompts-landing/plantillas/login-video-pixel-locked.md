# PLANTILLA — Login pixel-locked con video hero (calidad de referencia)

> **Origen:** entregado por el dueño el 2026-08-21 como estándar de calidad para logins.
> **Qué es:** spec completa de una página de login en un solo `index.html` autocontenido
> (video hero + card de formulario), con tokens calibrados al decimal, motor responsive
> de 3 modos por JS y animación de entrada WAAPI que corre una sola vez.
> **Cómo reutilizarla:** conservar la ARQUITECTURA (secciones 0, 2, 5–8: estructura,
> video con poster, motor de 3 modos, clearInline(), entrada con pre-paint guard) y
> reemplazar el CONTENIDO por proyecto: copy, paleta, tipografías, media y los valores
> de los tokens de la sección 3 (que se recalibran contra el frame de referencia del
> nuevo diseño — los números de abajo pertenecen al diseño "Signal", no son universales).
> Marca de la instancia original: "Signal" [DEMO/placeholder, no es marca de ningún cliente].
